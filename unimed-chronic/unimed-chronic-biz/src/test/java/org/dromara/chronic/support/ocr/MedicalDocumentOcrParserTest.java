 ...
 * @author unimed
 */
public class MedicalDocumentOcrParserTest {

    private final ObjectMapper objectMapper = new ObjectMapper();
    private final MedicalDocumentOcrArchiveMapper archiveMapper = new MedicalDocumentOcrArchiveMapper(objectMapper);
    private final MedicalDocumentOcrMetricMapper metricMapper = new MedicalDocumentOcrMetricMapper();
    private final MedicalDocumentOcrParser parser = new MedicalDocumentOcrParser(objectMapper, archiveMapper, metricMapper);
    ...
    public void parseMedicalRecordHomeShouldBuildArchiveDraft() {
        ...
        MedicalDocumentOcrParseResult result = parser.parse(BaiduOcrResponse.success(json), "MEDICAL_RECORD_HOME", null);
    ...
    public void parseLabReportShouldBuildMetricDraft() {
        ...
        MedicalDocumentOcrParseResult result = parser.parse(BaiduOcrResponse.success(json), "LAB_REPORT", 1001L);
