...
@AutoMapper(target = ChMedicalDocumentOcrTask.class)
public class MedicalDocumentOcrTaskVo implements Serializable {
    ...
    private MedicalDocumentOcrArchiveDraftVo archiveDraft;
    @Schema(description = "指标草稿")
    private List<MedicalDocumentOcrMetricItemVo> metricItems;
    @Schema(description = "报告项目草稿")
    private List<MedicalDocumentOcrReportItemVo> reportItems;
}
