...
public class MedicalDocumentOcrController {
    ...
    public TableDataInfo<MedicalDocumentOcrTaskVo> page(MedicalDocumentOcrTaskBo bo, PageQuery pageQuery) {
    ...
    public R<MedicalDocumentOcrTaskVo> detail(@Parameter(description = "任务ID") @PathVariable Long taskId) {
    ...
    public R<MedicalDocumentOcrConfirmResult> confirm(@Parameter(description = "任务ID") @PathVariable Long taskId,
                                                      @Validated @RequestBody MedicalDocumentOcrConfirmBo bo) {
