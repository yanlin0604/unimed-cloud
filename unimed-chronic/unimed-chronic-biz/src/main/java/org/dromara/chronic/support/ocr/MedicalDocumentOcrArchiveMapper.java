...
public class MedicalDocumentOcrArchiveMapper {

    private final ObjectMapper objectMapper;

    public ChMedicalDocumentOcrArchiveDraft buildArchiveDraft(JsonNode root, ChPatientProfileBo profile, List<ChPatientDiseaseBo> diseases) {
        ChMedicalDocumentOcrArchiveDraft draft = new ChMedicalDocumentOcrArchiveDraft();
